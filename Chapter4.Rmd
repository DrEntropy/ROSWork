...
For larger samples, the normal and binomal are closer.
...
If we assume a uniform prior, the distribution looks like this, enumerating the possible number of students who knew the answer:
...
So 95% of the density for f is contained in the interval from 36 to 53 students.

Could also make this a continuous distribution using gamma functions:
...
So the 95% range of f is from 0.38 to 0.54 , compares well to directly using binomial sampling distribution.
