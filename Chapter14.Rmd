...
(b) Make a graph similar to Figure 13.8b displaying Pr(switch) as a function of distance to
...
(e) Create indicator variables corresponding to dist < 100; dist between 100 and 200; and
...
binned |> 
  ggplot() +
  geom_point(aes(x=dist_cut, y= p_cut - .pred)) + 
  geom_errorbar(aes(x= dist_cut, ymin = p_cut - .pred - sd_cut,ymax = p_cut - .pred + sd_cut)) 
```
